...
<br>
	<div align="center">
		<h2>Have a Specific Question In Mind? Search Below!</h2>
		<br>
	
		<form action="searchedResults.jsp" method="post">
		
			Search: 
			<input class = "search_fields" type = "text" name="questionSearch" placeholder = "How to ....">
			<br>
			<br>
	...
	<h2>All Current Questions and Their Corresponding Answers:</h2>
	<br>
<%
...
String sentToRep = "SELECT * FROM email WHERE email.to = 'customerRep@buy.me\'";
